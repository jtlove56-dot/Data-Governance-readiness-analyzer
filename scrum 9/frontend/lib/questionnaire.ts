export const dataTypes = [
  {
    value: "names",
    label: "Names",
    example: "First names, surnames or full names",
  },
  {
    value: "email",
    label: "Email addresses",
    example: "Personal or work email addresses",
  },
  {
    value: "health",
    label: "Health information",
    example: "Conditions, treatments or medical records",
  },
  {
    value: "financial",
    label: "Financial information",
    example: "Income, bank details or transactions",
  },
  {
    value: "location",
    label: "Location information",
    example: "Addresses, GPS or travel history",
  },
  {
    value: "online_ids",
    label: "Online identifiers",
    example: "Device IDs, IP addresses or account IDs",
  },
  {
    value: "other",
    label: "Other data",
    example: "Any types that are not listed above",
  },
  {
    value: "unknown",
    label: "Some types are not yet known",
    example: "The data is still being explored",
  },
] as const;
...
export type Answers = {
  ...
  external_access: Choice | "";
  external_access_details: string;
  identifiable_exchange: Choice | "";
  data_movement: string;
  purpose: string;
  expected_output: string;
  secondary_use: Choice | "";
  secondary_use_details: string;
  reidentification: Choice | "";
  reidentification_details: string;
};
...
export const initialAnswers: Answers = {
  ...
  identifiable_exchange: "",
  data_movement: "",
  purpose: "",
  expected_output: "",
  secondary_use: "",
  secondary_use_details: "",
  reidentification: "",
...
export const steps: {
  ...
  {
    title: "Data",
    heading: "What data is involved?",
    description:
      "Include the types of information your use case will collect, use or share.",
    questions: [
      {
        key: "other_data_types",
        label: "What other data is involved?",
        type: "text",
  ...
  },
  {
    ...
    description:
      "Describe the people and organizations taking part in this use case.",
    questions: [
      {
        key: "people",
        label: "Which people are involved or affected?",
        type: "text",
        hint: "For example, customers whose data is used and analysts who handle it. Use roles or groups, not personal names.",
      },
      {
        key: "organizations",
        label: "Which organizations are taking part?",
        type: "text",
      ...
      {
        key: "external_access",
        label: "Will another organization access the data?",
        type: "choice",
        hint: "Access includes viewing data in your system, receiving a copy or processing it on your behalf.",
      },
      {
        key: "external_access_details",
        label: "Who will have access, and to what?",
        type: "text",
  ...
  {
    title: "Sharing",
    heading: "How will the data move?",
    description:
      "Consider each transfer between people, organizations and systems.",
    questions: [
      {
        key: "identifiable_exchange",
        label: "Will data that identifies people be exchanged?",
        type: "choice",
      ...
      {
        key: "data_movement",
        label: "Where does the data go, and how does it get there?",
        type: "text",
      ...
      },
      {
        ...
        label:
          "Could someone work out who a person is from shared data or results?",
        type: "choice",
      ...
      {
        key: "reidentification_details",
        label: "What could make someone identifiable?",
        type: "text",
  ...
  {
    title: "Purpose",
    heading: "What will the data be used for?",
    ...
    questions: [
      ...
      {
        key: "expected_output",
        label: "What will the work produce?",
        type: "text",
      ...
      {
        key: "secondary_use",
        label: "Might the data be used for another purpose later?",
        type: "choice",
        hint: "This is called secondary use. Examples include a future research project, marketing or training an AI model.",
      },
      {
        key: "secondary_use_details",
        label: "What other uses are possible?",
        type: "text",
...
export function validateStep(answers: Answers, step: number): Errors {
  ...
  if (step === 0 && answers.data_types.length === 0) {
    errors.data_types =
      "Select at least one data type, or indicate that types are not yet known.";
  }
    ...
    if (!value)
      errors[question.key] =
        question.type === "choice"
          ...
          : "Enter an answer. If details are unknown, say what still needs to be decided.";
    else if (value.length > 2000)
      errors[question.key] = "Keep your answer to 2,000 characters or fewer.";
  }
  return errors;
}
